...
if (!empty($_POST)) {
    ...
    $query        = " SELECT 1 FROM signup WHERE username = :user";
   ...
   $query = "UPDATE signup SET name=:name, mobile=:mobile, country= :count WHERE username= :user";
...
This is to inform you that your Profile how now been updated.
...
$response["success"] = 0;
    $response["message"] = "Unable to register , Enter Valid details or try after sometime!";
    die(json_encode($response));
	}
