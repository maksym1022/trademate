...
if (!empty($_POST)) {
    ...
    if (empty($_POST['username']) || empty($_POST['npassword']) || empty($_POST['opassword']))  {
        
        
        // Create some data that will be the JSON response 
        $response["success"] = 0;
        $response["message"] = "Please enter a Username and Password.";
    ...
    $query        = " SELECT 1 FROM signup WHERE username = :user and password= :opass " ;
    ...
    $query = "UPDATE signup SET password= :pass WHERE username= :user and password= :opass ";
...
Your profile has now been updated.
If you did not request those changes please contact us as soon as possible.
