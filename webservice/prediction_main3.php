...
$reply['status']=1;*/
    ...
    $ar2 = $result['best'];
    $ar3 = $result['name'];
    $ar4 = $result['groupname'];
    $ar10 = $result['showLabel'];
    $ar5 = $result['id'];
    $ar6 = $result['predict_high'];
    $ar7 = $result['predict_low'];
    $ar8 = $result['trend'];
    $ar9 = $result['flag'];
    
    array_multisort($result['gid'], SORT_ASC, SORT_NUMERIC
        , $result['best'], SORT_DESC, SORT_NUMERIC
        , $result['name'], $result['groupname'], $result['showLabel']
        , $result['id'], $result['predict_high']
        , $result['predict_low'], $result['trend'], $result['flag']);
